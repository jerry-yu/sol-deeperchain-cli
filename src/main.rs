...
use solana_sdk::{
    ...
    transaction::Transaction,program_error::ProgramError
};
use std::str::FromStr;
use sol_deeperchain::{ state::{UserAccount,TokenAccount,CreditSetting,CreditSettings},
...
fn main() {
    ...
    // set token address
    let new_token_address = Pubkey::from_str("Fnz5v84PBHN3qLSz5heV3XucTnDy2TkUZD9EEC1Sr7Aw").unwrap();

    let token_instruction = CreditInstruction::SetTokenAddress { address: new_token_address};
